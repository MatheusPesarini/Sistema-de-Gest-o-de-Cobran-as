            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h4 class="mb-0"><i class="bi-pencil-square"></i> Editar Cliente</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <g:form resource="${cliente}" controller="cliente" method="PUT">
                            ...
                            <div class="mb-3">
                                ...
                                <g:textField name="nome" value="${cliente?.nome}" class="form-control" required="required"/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold" for="cpfCnpj">CPF / CNPJ <span class="text-danger">*</span></label>
                                <g:textField name="cpfCnpj" value="${cliente?.cpfCnpj}" class="form-control" required="required"/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold" for="email">E-mail <span class="text-danger">*</span></label>
                                <g:textField name="email" value="${cliente?.email}" class="form-control" required="required"/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold" for="telefone">Telefone</label>
                                <g:textField name="telefone" value="${cliente?.telefone}" class="form-control"/>
                            </div>
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi-floppy"></i> Atualizar
                                </button>
                                <g:link action="show" id="${cliente?.id}" class="btn btn-outline-secondary">
